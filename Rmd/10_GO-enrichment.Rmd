...
{
  temp <- enrichGO(gene = genes_list_arab[[i]][[2]],
                   OrgDb = organism,
                   keyType = KEYTYPE,
                   ont = ONT,
  ...
  if (empty == FALSE)
  {
    ...
    number_genes_enrichment[[LIST_LEVEL]][[name]] <- length(genes_list_arab[[i]][[2]])
  } else {
...
### Convert IDs Arabidopsis to original organism and save
