...
from_CRAN <- c("ggplot2", "igraph", "tidyverse", "tidygraph", "dplyr", "data.table", "ggvenn", "rmarkdown", "knitr", "plotly", "venn", "tm", "wordcloud", "shiny", "factoextra", "cluster", "dynamicTreeCut", "devtools", "RColorBrewer", "pheatmap", "reshape2", "ggcharts")
