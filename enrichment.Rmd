---
title: "`r MY_TITLE`"
subtitle: "Enrichment analysis with ClusterProfiler"
...
Verify which accesory files were defined by user
...
Load functional data for reference organism

```{r}
# organism ####
ORG_ORIG <- paste0("ID_", ORG_ORIG)
# organism for enrichment
# CONSTRUIR UNA TABLA CON LAS OPCIONES A LA QUE LE PASAMOS REFERENCE_ORG
...
OrgDb_custom <- data.frame("number" = 1:3,
                           ...
                           "package" = c("org.At.tair.db", "org.Dr.eg.db", "org.Hs.eg.db"),
                           "kegg" = c("ath", "dre", "hsa"))
...
Minimun number of genes for enrichment plots | `r MIN_GENES`
...
```{r ortologs, warning=FALSE, message=FALSE, fig.show = "hold", out.width = "50%"}
# creamos una lista
